...
```
systemd-socket-activate -E WAYLAND_DISPLAY=$WAYLAND_DISPLAY -E XDG_RUNTIME_DIR=$XDG_RUNTIME_DIR --fdname "varlink" -l /tmp/xdp-ng-example.socket target/debug/dynamic_launcher
```
